    ...
    <div class="container pb-lg-3">
        ...
        <div class="row">
            <div class="col-md-6 latest-left">
                <div class="product-shoe-info shoe text-center">
                    <?php
                    echo '<img src="./uploads/' . $sphome2[0]['img'] . '" class="img-fluid" alt="">
                    <div class="shop-now"><a href="shop.html" class="btn">' . $sphome2[0]['tensp'] . '</a></div>';
                    ?>
                </div>
            </div>
                ...
                <div class="row latest-grids">
                    <div class="latest-grid1 product-men col-12">
                        <div class="product-shoe-info shoe text-center">
                            <div class="men-thumb-item">
                                <?php
                                echo '<img src="./uploads/' . $sphome2[1]['img'] . '" class="img-fluid" alt="">
                    ...
                    <div class="latest-grid2 product-men col-12 mt-lg-4">
                        <div class="product-shoe-info shoe text-center">
                            <div class="men-thumb-item">
                                <?php
                                echo '<img src="./uploads/' . $sphome2[2]['img'] . '" class="img-fluid" alt="">
